...
def loadCam(args, id, cam_info, resolution_scale, is_nerf_synthetic):
    ...
    return Camera(resolution, colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
                  FoVx=cam_info.FovX, FoVy=cam_info.FovY, K=cam_info.K, depth_params=cam_info.depth_params,
...
def camera_to_JSON(id, camera : Camera):
    ...
    camera_entry = {
        ...
        'fy' : int(fov2focal(camera.FovY, camera.height)),
        'fx' : int(fov2focal(camera.FovX, camera.width))
    }
    return camera_entry